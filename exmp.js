			...
			var guis = {
				...
				LatheBufferGeometry: function ( mesh ) {
					...
					function generateGeometry() {
						...
						var geometry = new LatheBufferGeometry(
				...
				TextBufferGeometry: function ( mesh ) {
					...
					function generateGeometry() {
						...
						loader.load( '../../examples/fonts/' + data.font + '_' + data.weight + '.typeface.json', function ( font ) {
							...
							var geometry = new TextBufferGeometry( data.text, {
								font: font,
								size: data.size,
								height: data.height,
								curveSegments: data.curveSegments,
				...
				ShapeGeometry: function ( mesh ) {
					...
					function generateGeometry() {
						...
						var geometry = new ShapeGeometry( heartShape, data.segments );
						geometry.center();
				...
				ShapeBufferGeometry: function ( mesh ) {
					...
					function generateGeometry() {
						...
						var geometry = new ShapeBufferGeometry( heartShape, data.segments );
						geometry.center();
				...
				ExtrudeGeometry: function ( mesh ) {
					...
					function generateGeometry() {
						...
						var geometry = new ExtrudeGeometry( shape, data );
						geometry.center();
